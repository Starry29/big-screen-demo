...
export const Chart8 = () => {
  ...
  useEffect(() => {
    setInterval(() => {
      const newData = [
        { value: Math.random() * 1, name: '10-20' },
        { value: Math.random() * 1, name: '20-30' },
        { value: Math.random() * 1, name: '30-40' },
        { value: Math.random() * 1, name: '40-50' },
        { value: Math.random() * 1, name: '50-60' },
      ];
      x(newData);
    }, 1000);
  }, []);
